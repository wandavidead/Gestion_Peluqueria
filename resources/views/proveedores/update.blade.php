	...
	<div class="card card-outline-secondary">
		...
		<div class="card-body">
			<form
				class="form"
				method="POST"
				action="{{ route('proveedores.update',$proveedores->id) }}"
				role="form"
			>
				@method('PUT') @csrf
				<div class="form-group row">
					<label class="col-lg-3 col-form-label form-control-label"
						>@lang('Social denomination')</label
					>
					<div class="col-lg-9">
						<input
							type="text"
				...
				<div class="form-group row">
					...
					<div class="col-lg-9">
						<a href="{{ route('proveedores.index') }}" class="btn btn-info btn-block"
							>@lang('Return')</a
						>
						<input
							type="submit"
